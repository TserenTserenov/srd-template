...
### 3.3. Согласованность иерархии систем

**Источник:** `0.2.Kernels-Bridge/03-systems-hierarchy.md`

**Что проверяем:**
- Иерархия не содержит циклов
- Все системы из ядер присутствуют в иерархии
