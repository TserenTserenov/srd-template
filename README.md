...
|-----------|---------|------|------------|-------------------|
| **F0** | Management | Мета | Управление хранилищем | AI-агенты, администраторы |
| **F1** | Supersystem | Предприниматель | Контекст, рынок, ценность | Внешние проектные роли, инвесторы |
| **F2** | Supersystem | Инженер | Окружение, интерфейсы | Пользователи, аналитики |
| **F3** | Supersystem | Менеджер | Взаимодействие, партнёрства | Партнёры, регуляторы |
| **F4** | TargetSystem | Предприниматель | Требования, ценность продукта | Product Owner, заказчики |
| **F5** | TargetSystem | Инженер | Архитектура продукта | Архитекторы, разработчики |
| **F6** | TargetSystem | Менеджер | Реализация, процессы | Разработчики, QA |
| **F7** | CreationSystem | Предприниматель | Принципы, экономика | Фаундеры, инвесторы |
| **F8** | CreationSystem | Инженер | Платформа, инструменты | DevOps, архитекторы |
| **F9** | CreationSystem | Менеджер | Команда, методология | Менеджеры, HR |
